    ...
    <div className='mt-5 '>
      <div className="carousel w-full">
        <div id="item1" className="carousel-item w-full">
          <img src='https://img.freepik.com/free-vector/superhero-blank-border_1308-24972.jpg?w=1380&t=st=1684401989~exp=1684402589~hmac=fa28ea4c7841bcc254ea51e969a80e876eaa6578c08e6934faf295db6bb8608e' className="w-1/2 mx-auto" />
        ...
        <div id="item2" className="carousel-item w-full">
          <img src='https://i.ibb.co/ZKW2GqV/three-toy-robots-are-table-one-which-is-robot-782419-9662.jpg' className="w-1/2 mx-auto" />
          <div className="overlay">
          <h1 className='md:text-2xl'>Captain America Shield Roleplay Set</h1> 
        ...
        <div id="item3" className="carousel-item w-full">
          <img src="https://i.ibb.co/Dg7Ndct/kids-superheroes-vector-illustration-with-team-comic-cartoon-characters-dressed-1284-15220.jpg" className="w-1/2 mx-auto" />
          <div className="overlay">
        ...
        <div id="item4" className="carousel-item w-full">
          <img src='https://i.ibb.co/8DNB68M/superheroes-outer-space-1308-25562.jpg' className="w-1/2 mx-auto" />
          <div className="overlay">
          <h1 className='md:text-2xl'>Iron Man Mark XLIII Action Figure</h1> 
            <p className=''>Unleash your imagination with this action-packed set of Marvel superheroes. <br /> Join Iron Man, Spider-Man, and the Hulk as they team up to save the world from <br /> supervillains. With detailed figures and accessories, you can create your own <br /> epic battles and heroic adventures.</p>
